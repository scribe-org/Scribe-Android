...
class AboutUtilTest {
    ...
    fun testGetFeedbackAndSupportList_correctItemGeneration() {
        ...
        assertEquals(R.string.i18n_app_about_feedback_email, list[2].title)
        assertEquals(R.string.i18n_app_about_feedback_version, list[3].title)
        assertEquals(R.string.i18n_app_about_feedback_app_hints, list[4].title)
    ...
    fun `getLegalItemSpecs returns expected list`() {
        ...
        assertEquals(R.string.i18n_app_about_legal_privacy_policy, specs[0].title)
