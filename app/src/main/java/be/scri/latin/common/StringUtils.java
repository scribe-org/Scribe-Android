...
public final class StringUtils {
    ...
    private static boolean scriptSupportsUppercase(final Locale locale) {
        final String lang = locale.getLanguage();
        return !lang.equals("ar") && !lang.equals("he") && !lang.equals("iw") && !lang.equals("hi") && !lang.equals("ta") && !lang.equals("ml");
    }

    @Nullable
    public static String toTitleCaseOfKeyLabel(@Nullable final String label,
                                               @NonNull final Locale locale) {
        if (label == null || !scriptSupportsUppercase(locale)) {
            return label;
        }
        if (label.equals("ß"))
    ...
    public static int toTitleCaseOfKeyCode(final int code, @NonNull final Locale locale) {
        ...
        return codePointCount(titleCaseLabel) == 1
                ? titleCaseLabel.codePointAt(0) : Constants.KeyCode.NOT_SPECIFIED;
    }
