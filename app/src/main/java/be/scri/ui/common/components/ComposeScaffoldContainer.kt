/**
 * A composable function for a screen layout in the main activity, featuring a scrollable column with a title, a content area inside a card, and customizable bottom spacing.
 *
