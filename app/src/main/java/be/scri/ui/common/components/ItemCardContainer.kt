/**
 *  A composable function that displays a list of items (clickable, switchable, or external link) inside a card container, with an optional divider between items.
 *
