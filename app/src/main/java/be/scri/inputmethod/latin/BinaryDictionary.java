...
package be.scri.inputmethod.latin;

import android.text.TextUtils;
import be.scri.latin.utils.ChecksumCalculator;
import be.scri.latin.utils.Log;
import android.util.SparseArray;

import androidx.annotation.NonNull;

import be.scri.latin.dictionary.Dictionary;
import be.scri.latin.NgramContext;
import be.scri.latin.SuggestedWords.SuggestedWordInfo;
import be.scri.latin.common.ComposedData;
import be.scri.latin.common.Constants;
import be.scri.latin.common.FileUtils;
import be.scri.latin.common.InputPointers;
import be.scri.latin.common.StringUtils;
import be.scri.latin.makedict.DictionaryHeader;
import be.scri.latin.makedict.FormatSpec.DictionaryOptions;
import be.scri.latin.makedict.UnsupportedFormatException;
import be.scri.latin.makedict.WordProperty;
import be.scri.latin.settings.SettingsValuesForSuggestion;
import be.scri.inputmethod.latin.utils.BinaryDictionaryUtils;
import be.scri.latin.utils.JniUtils;
import be.scri.inputmethod.latin.utils.WordInputEventForPersonalization;
