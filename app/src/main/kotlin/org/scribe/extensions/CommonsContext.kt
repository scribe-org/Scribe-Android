...
import org.scribe.models.AlarmSound
import org.scribe.models.BlockedNumber
import java.io.File
...
fun Context.isAProApp() = packageName.startsWith("org.scribe.") && packageName.removeSuffix(".debug").endsWith(".pro")
