...
internal fun setKeyboardAlternateKeys() {
    ...
    keyAlternatesDict = mapOf(
        "a" to aAlternateKeys,
        "e" to eAlternateKeys,
        "е" to еAlternateKeys, // Russian е
        "i" to iAlternateKeys,
        "o" to oAlternateKeys,
        "u" to uAlternateKeys,
        "ä" to äAlternateKeys,
        ...
        "n" to nAlternateKeys,
        "ь" to ьAlternateKeys,
        "/" to backslashAlternateKeys,
        "?" to questionMarkAlternateKeys,
        "!" to exclamationAlternateKeys,
        "%" to percentAlternateKeys,
        "&" to ampersandAlternateKeys,
        "'" to apostropheAlternateKeys,
        "\"" to quotationAlternateKeys,
        "=" to equalSignAlternateKeys,
        currencySymbol to currencySymbolAlternates
    )
}
 ...
 *
 * @param startX The x-axis starting point.
 * @param startY The y-axis starting point.
 * @param keyHeight The height of the key.
 * @param numAlternates The number of alternate characters to display.
 * @param side The side of the keyboard that the key is found.
 */
internal fun setAlternatesPathState(
    startY: CGFloat, keyWidth: CGFloat, keyHeight: CGFloat, numAlternates: CGFloat, side: String
    ) {
    if (DeviceType.isPad) {
        widthMultiplier = 0.2
 ...
 * @param numAlternates The number of alternate characters to display.
 */
internal fun alternateKeysPathLeft(
    startX: CGFloat, startY: CGFloat, keyWidth: CGFloat, keyHeight: CGFloat, numAlternates: CGFloat
    ) : UIBezierPath {
 ...
 * @param numAlternates The number of alternate characters to display.
 */
internal fun alternateKeysPathRight(
    startX: CGFloat, startY: CGFloat, keyWidth: CGFloat, keyHeight: CGFloat, numAlternates: CGFloat
    ) : UIBezierPath {
    // Starting positions need to be updated.
    horizStart = startX
    ...
    path.addCurve(
        ...
        controlPoint1 = CGPoint(
            x = horizStart + (keyWidth * (1 + widthMultiplier)), y = vertStart - (keyHeight * 1.05)
        ),
...
internal fun genAlternatesView(key: Button) {
    ...
    alternatesKeyView = View(frame = CGRect(
        x = alternatesViewX,
        y = alternatesViewY,
