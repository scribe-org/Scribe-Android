...
enum class RussianKeyboardConstants {
    ...
    internal val letterKeysPhone = listOf(
        ...
        listOf("shift", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "delete"),
    ...
    internal val numberKeysPhone = listOf(
        ...
        listOf("-", "/", ":", ";", "(", ")", "₽", "&", "@", "\""),
        listOf("#+=", ".", ",", "?", "!", "'", "delete"),
        listOf("АБВ", "selectKeyboard", "space", "return") // "undoArrow"
    )
    ...
    internal val letterKeysPad = listOf(
        listOf("й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "delete"),
        listOf("ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э", "return"),
        listOf("shift", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", ".", "shift"),
    ...
    internal val numberKeysPad = listOf(
        ...
        listOf("@", "#", "№", "₽", "ʼ", "&", "*", "(", ")", "'", "\"", "return"),
        listOf("#+=", "%", "_", "-", "+", "=", "≠", ";", ":", ",", ".", "#+="),
        listOf("АБВ", "selectKeyboard", "space", "АБВ", "hideKeyboard") // "undoArrow"
    )
