...
Privacy Policy
  """, attributes = mapOf<NSAttributedString.Key.font , UIFont.boldSystemFont(ofSize = fontSize * 1.5)>)
    val wikidataDataLicensing: String = "https://www.wikidata.org/wiki/Wikidata:Licensing"
    val huggingFaceLicensing: String = "https://github.com/huggingface/transformers/blob/master/LICENSE"
    val scribeGitHub: String = "https://github.com/scribe-org"
